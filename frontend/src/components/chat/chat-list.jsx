...
export const ChatList = ({ chats=[], selectAChat }) => {
  const { pageDetails } = useSelector((state) => state.fb);
          ...
          >
            <div className="flex w-full items-center gap-3">
              ...
              <div className="flex flex-col items-start w-[80%]">
                ...
                <span className="text-sm opacity-70">{pageDetails?.name || "Facebook DM"}</span>
              </div>
